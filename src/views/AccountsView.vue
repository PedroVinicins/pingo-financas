...
<template>
  <div>
    <div class="sticky top-0 z-20 mx-auto max-w-[1440px] bg-canvas/90 px-5 pb-1 pt-[calc(.75rem+env(safe-area-inset-top))] backdrop-blur-xl sm:px-7 lg:top-0 lg:px-10 lg:pt-5">
      <div class="inline-grid grid-cols-2 rounded-2xl bg-muted p-1" role="tablist" aria-label="Seções de contas">
