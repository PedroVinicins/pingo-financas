...
import { AlertCircle, CheckCircle2, FileSpreadsheet, FileUp, Landmark, X } from 'lucide-vue-next'
import type {
  BankStatementImportInput, Category, ParsedBankStatement, Transaction,
} from '../types/finance'
import {
  duplicateStatementRows, parseBankStatementFile, statementFormatLabel,
} from '../services/bankStatement'

const props = defineProps<{ categories: Category[]; transactions: Transaction[]; busy?: boolean }>()
