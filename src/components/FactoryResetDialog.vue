...
<template>
  <Teleport to="body">
    <div class="pingo-modal-backdrop fixed inset-0 z-[120] grid place-items-end bg-slate-950/65 backdrop-blur-[2px] sm:place-items-center sm:p-4" @click.self="!busy && emit('cancel')">
      <section class="pingo-modal-panel w-full rounded-t-[2rem] bg-white p-5 shadow-2xl dark:bg-slate-900 sm:max-w-md sm:rounded-[2rem] sm:p-6" role="alertdialog" aria-modal="true" aria-labelledby="factory-reset-title">
